...
Valori ammessi per `style`: `classico` oppure `immersivo`. Copia l'immagine nella cartella `assets`; se `image` è vuoto, la scheda funziona comunque. I tre progetti già presenti sono dichiarati come concept dimostrativi.
